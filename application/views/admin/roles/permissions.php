<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <input type="button" class="form-control btn btn-info" name="add_job" value="Add Permissions"  onclick="showCreateDialog()">
      </div>
      </div>
...
<?php $sr++; //} ?>
  ...
  <!-- /.content-wrapper -->
    ...
    <form class="form-horizontal" role="form" method="post"  action="<?php //echo base_url().'Welcome/medicines/create/'.$user_id; ?>">
      ...
      <input type="text" class="form-control" id="car" placeholder="Enter Page Name" name="name">
      </div>
